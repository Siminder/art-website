       ...
       <div className='block'>
            <div className='relative h-full w-full block'>
                <div className='grid grid-cols-9 grid-rows-5'> 
                    <div className='col-start-2 col-end-10 row-start-1 row-end-6 z-0 pr-[10rem]'>
                        <div className='justify-start flex h-full w-full flex-col pt-0 pb-0'>
                            <div className='outline-none '>
                                <div className='mb-0 mt-0 break-words outline-none '>
                                    ...
                                    <p className='text-center whitespace-pre-wrap m-1 text-black underline  '>
                                        ...
                                        <a href='/' className='inline-block break-word p-2 '>Others</a>
                                    </p>
